...
var sounds = {
	...
	"steel_drip": preload("res://assets/audio/sfx/steel_drip.mp3"),
	"spikes_down": preload("res://assets/audio/sfx/spikes_down.mp3"),
	...
	"three_shot_burst": preload("res://assets/audio/sfx/three_shot_burst.mp3"),
